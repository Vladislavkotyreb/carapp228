...
struct PlacesList: View {
    ...
    private func line(_ row: PlaceRow) -> some View {
        ...
        // Звонок — свайпом справа налево… нет, слева направо: правый край
        // занят удалением и звездой, а складывать разрушающее действие рядом
        // со звонком значит однажды удалить место вместо вызова.
